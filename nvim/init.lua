...
vim.opt.signcolumn = 'yes' -- Signcolumn (Errors)
vim.opt.updatetime = 250 -- Update Time
vim.opt.list = true -- Enable ListChars
vim.opt.listchars = { tab = '» ', trail = '·', nbsp = '␣' } -- Add Chars
vim.opt.inccommand = 'split' -- Preview Substitutions
vim.opt.cursorline = true -- Line Under Cursor

-- Basic Keymaps

-- Set Hightlight on Search and Clear w/ Esc
...
require('lazy').setup({
  ...
  { 'numToStr/Comment.nvim', opts = {} }, -- Comment with `gcc`
